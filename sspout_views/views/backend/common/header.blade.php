            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        ...
                        <span class="hidden-xs">{{ Auth::guard('admin_user')->user()->username }}</span>
                        @endif
                    </a>
                    <ul class="dropdown-menu">
                        <!-- User image -->
                        <li class="user-header">
                            ...
                            <p>
                                @if (Auth::guard('admin_user')->user())
                                    {{ Auth::guard('admin_user')->user()->first_name }} {{ Auth::guard('admin_user')->user()->last_name }}
                                @endif
                            </p>
                        </li>
                        <!-- Menu Footer-->
                        <li class="user-footer">
                            ...
                            <div class="pull-right">
                                <a class="btn btn-default btn-flat" href="{{ url('admin/logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                                    Sign out
                                </a>
